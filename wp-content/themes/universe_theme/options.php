...
function optionsframework_options() {
    ...
    $options['map_api_key'] = array(
        'name' => __('Google Maps API Key', 'options_framework_theme'),
        'desc' => __('Paste here the API key for your map. Please visit <a href="https://code.google.com/apis/console" target="_blank">https://code.google.com/apis/console</a> in order to learn more on how to get the API key.', 'options_framework_theme'),
        'id' => 'map_api_key',
        'std' => '',
        'type' => 'text');
